 ...
 * 最大堆：对于节点i来说，除了根节点外，其余所有的节点满足：A[PARENT] >= A[i]
 * 最小堆：对于节点i来说，除了根节点外，其余所有的节点满足：A[PARENT] <= A[i]
...
public class Heap {
    ...
    /**
     * 堆最大化节点：将堆的第i个节点根节点最大化（以i节点为根节点的子树，根节点最大化）
     * 算法：对于第i个节点，比较第i个节点和它的左右子孩子，将i节点和这3个中最大的节点调换位置。完成一次调换。
     *       递归调整下去的节点，以保证下边的有序。
     * @param i
     */
